  ...
  Future<void> _submitForm() async {
    ...
    if (farmerId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text("Please sign in again to submit your soil test report."),
        ),
      );
    ...
    final report = SoilTestReport(
      ...
      micronutrients: _micronutrientsController.text.trim(),
        ...
        SnackBar(
          content: Text(
            widget.initialReport == null
                ? "Unable to submit your soil test report. Please try again."
                : "Unable to update your soil test report. Please try again.",
          ),
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          validator: (value) {
                            if (value == null || value.isEmpty) {
                              return 'Please select soil texture.';
                            }
                            return null;
                          },
                        ),
